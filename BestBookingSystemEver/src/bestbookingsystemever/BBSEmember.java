...
public class BBSEmember {

    JFrame frame;
    MemberRepository mrepo = new MemberRepository();
    
    public BBSEmember(JFrame frame) {
        this.frame = frame;
    }
    ...
    public void member() {
        ...
        JLabel top = new JLabel("Add a member");
        ...
        JLabel employee = new JLabel("Name: ");
        ...
        save.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                boolean ok = mrepo.addMember(mName);
                if(ok == false){
                    message.add(new JLabel("Could not save member"));
                } else {
                    message.add(new JLabel("Successfully saved a member"));
                }
                message.repaint();
                message.validate();
            }
